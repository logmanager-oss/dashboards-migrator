// Package cli implements the command-line interface for dashboards-migrator.
package cli
...
func CLIStart() error {
	...
	lm4dashboard, err := migrator.Migrate(lm4Dashboard, lm3Dashboard, config.IndexPattern)
	if err != nil {
