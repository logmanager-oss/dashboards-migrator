...
func (d *LM4Dashboard) SetAndAppendGridData(w int, h int, id string, title string) {
...
func (d *LM4Dashboard) SetAndAppendReference(id string, refType string) {
...
func (d *LM4Dashboard) calculateCurrentCoordinates(w int, h int) lm4.GridData {
...
func (d *LM4Dashboard) BuildFinalDashboardObject() (*lm4.SavedObject, error) {
