...
func TestMigrator_migrateVisualizations(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			expected: `{"attributes":{"columns":["meta.src.ip@ip.value","raw"],"description":"","hits":0,"kibanaSavedObjectMeta":{"searchSourceJSON":"{\"highlightAll\":true,\"version\":true,\"query\":{\"query\":\"\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"},"sort":[],"title":"Log Overview","version":1},"id":"","migrationVersion":{"search":"7.9.3"},"references":[{"id":"test","name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern"}],"type":"search","updated_at":"0001-01-01T00:00:00Z","version":""}`,
		},
		{
			...
			expected: `{"attributes":{"columns":["meta.src.ip@ip.value","raw"],"description":"","hits":0,"kibanaSavedObjectMeta":{"searchSourceJSON":"{\"highlightAll\":true,\"version\":true,\"query\":{\"query\":\"msg.protocol:TCP or msg.protocol:UDP\",\"language\":\"kuery\"},\"filter\":[],\"indexRefName\":\"kibanaSavedObjectMeta.searchSourceJSON.index\"}"},"sort":[],"title":"Log Overview With Filters","version":1},"id":"","migrationVersion":{"search":"7.9.3"},"references":[{"id":"test","name":"kibanaSavedObjectMeta.searchSourceJSON.index","type":"index-pattern"}],"type":"search","updated_at":"0001-01-01T00:00:00Z","version":""}`,
		},
		{
